...
class RegistrationTest {
	...
	private static Stream<Arguments> validRegistrationData() {
		return Stream.of(Arguments.of("abcd", OK_EMAIL), Arguments.of("abcdeabcdeabcde", OK_EMAIL),
				Arguments.of(OK_USERNAME, OK_EMAIL), Arguments.of(OK_USERNAME, "a@b"));
	}

	private Registration createRegistration(String username, String email) {
		return Registration.builder().userName(username).password(OK_PASSWORD).confirmPassword(OK_CONFIRM_PASSWORD)
				.email(email).build();
	...
	private static Stream<Arguments> invalidRegistrationData() {
		return Stream.of(Arguments.of("abc", OK_PASSWORD, OK_CONFIRM_PASSWORD, OK_EMAIL, "userName"),
				Arguments.of("abcdeabcdeabcdea", OK_PASSWORD, OK_CONFIRM_PASSWORD, OK_EMAIL, "userName"), 
				...
				Arguments.of(OK_USERNAME, "123456789012345678901", "123456789012345678901", OK_EMAIL, "password"),
	...
	void testInvalidRegistration(String username, String password, String confirmPassword, String email, String expected) {
		Registration invalidRegistration = Registration.builder().userName(username).password(password).
